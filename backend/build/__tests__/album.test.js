...
describe("test relating to albums", function () {
    it("successfully searches for an album", function () { return __awaiter(void 0, void 0, void 0, function () {
        var queryParams, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    queryParams = "227789382";
                    return [4 /*yield*/, supertest_1.default(app_1.default)
...
describe("user can interact with an album", function () {
    it("user successfully listens to an album", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.default)
    ...
    it("user successfully likes an album", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.default)
