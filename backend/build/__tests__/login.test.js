...
describe("User  Login", function () {
    it("should create login a registered user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var logUser, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supertest_1.default(app_1.default).post(url + "users/login").send(logUser)];
                case 1:
                    res = _a.sent();
