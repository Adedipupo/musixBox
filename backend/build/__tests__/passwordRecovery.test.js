...
var token;
var url = "/api/v1/music-box-api/users";
var userInfo = {
    firstName: "David",
    lastName: "Adejo",
    gender: "Male",
...
beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, supertest_1.default(app_1.default).post(url + "/register").send(userInfo)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
describe("Request Password Recovery", function () {
    it("should generate a password recovery link for user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
describe("Reset Password", function () {
    ...
    it("should log user in with new password", function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.default)
